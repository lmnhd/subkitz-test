  ...
  const KeyPad = ({
    ...
    return (
      <div>
        ...
        <div
          className={cn(
            `relative flex items-center justify-center w-6 h-20 md:w-12 md:p-2 mx-1 text-white border-[1px] border-pink-300 rounded-xl md:hover:bg-lime-800 cursor-pointer `,
        ...
        >
         {/* TOP BUTTON */}
         <div className="absolute top-0 left-0 rounded-xl w-full flex justify-center items-center h-[30%] bg-black/10 hover:bg-red-500">
          ...
          <div
            className={cn(
              `absolute bottom-0 w-6 h-[80%] md:w-12 md:p-2 mx-1 rounded-sm bg-white/10 `,
        
            )}></div>
             {/* BOTTOM BUTTON */}
             <div className="absolute bottom-0 left-0 rounded-xl w-full flex justify-center items-center h-[30%] bg-black/10 hover:bg-red-500">-</div>
          <span>{stepNum + 1}</span>
        ...
        {/* <div
          className={cn(
            `absolute bottom-0 w-6 h-[100%] md:w-12 md:p-2 mx-1 rounded-xl bg-white-500/40 `,
