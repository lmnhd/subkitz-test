  ...
  return (
    <div className="">
      <div className="flex md:gap-6">
        <label htmlFor="" className={`w-16 md:w-16 h-8 md:pl-6 font-normal text-center text-${color}-400`}>
          {fieldName}
        </label>
        <select
          //name={fieldName}
          ...
          value={value}
          //defaultValue={value}
          className={`text-black w-12 md:w-16 h-8`}
          onChange={(e) => {
...
export default function SampleProperties({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-xs bg-gradient-to-b from-slate-800 to-slate-900">
      <h1 className="font-extralight text-lime-400">edit sample properties</h1>
      <div className="flex flex-row flex-wrap items-center justify-center w-full gap-2 p-1">
        ...
        <div className="flex gap-6">
          <label
            htmlFor="reversed"
            className="w-12 h-8 text-center text-pink-300 md:w-16 md:pl-6"
          >
            reversed
          </label>
          <input
